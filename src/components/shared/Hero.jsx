...
const Hero = () => {
  return (
    <section className="w-full relative">
      ...
      <div
        className="relative w-full bg-cover bg-center bg-no-repeat flex flex-col items-center pt-11 md:pt-18 pb-20" 
        style={{ backgroundImage: `url(${heroImg})`, height: "450px" }}
      >
        {/* ====================== Dark Overlay ========================= */}
        ...
        <div className="relative z-10 px-4 w-full max-w-6xl mx-auto flex flex-col items-center">
          ...
          <h1 className="text-4xl md:text-4xl font-bold drop-shadow-2xl text-white text-center">
            Your Trip Starts Here!
          </h1>
          
          <p className="text-lg md:text-lg opacity-90 max-w-4xl mb-2 text-white text-center leading-relaxed">
