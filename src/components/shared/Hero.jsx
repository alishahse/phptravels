...
const Hero = () => {
  return (
    <section className="w-full relative">
      ...
      <div
        className="relative w-full min-h-70 md:min-h-90 bg-cover bg-center bg-no-repeat flex flex-col items-center pt-11 md:pt-18 pb-20" 
      ...
      >
        ...
        <div className="relative z-10 px-4 w-full max-w-6xl mx-auto flex flex-col items-center">
          ...
          <h1 className="text-3xl md:text-4xl font-bold drop-shadow-2xl text-white text-center">
            Your Trip Starts Here!
          </h1>
          
          <p className="text-lg md:text-xl opacity-90 max-w-4xl mb-6 text-white text-center leading-relaxed">
